...
import {View, ImageProps, StyleSheet} from 'react-native';
import {
  Layout,
  Button,
  Input,
...
export default function MerchantList(): React.ReactElement {
  ...
  const ItemImage = (props: ImageProps): React.ReactElement => (
    <Avatar {...props} style={[props.style, styles.itemImage]} />
  );
  ...
  return (
    <Layout style={styles.container}>
      <View style={styles.searchContainer}>
        ...
        />
        <Button appearance="outline" status="primary" onPress={onSearch}>
          搜索
        </Button>
      </View>
      <List data={displayed} renderItem={renderItem} />
    </Layout>
  );
}
